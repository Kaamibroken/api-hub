...
export async function fetchTransformedData() {
    ...
    const fullUrl = `${BASE_URL}?fdate1=${encodeURIComponent(
        DATE_START
    )}&fdate2=${encodeURIComponent(
        DATE_END
...
export default { fetchTransformedData };
