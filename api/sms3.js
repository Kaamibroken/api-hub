  ...
  try {
    ...
    let resultData;
      ...
      const params = querystring.stringify({
        fdate1: fdate1, fdate2: fdate2, frange: "", fclient: "", fnum: "", fcli: "", fg: "0", csstr: csstrToken, sEcho: "1", iDisplayLength: "100", sSearch: "", bRegex: "false"
      });
      ...
      const smsResp = await makeRequest("GET", smsUrl, null, { "Referer": `${CONFIG.baseUrl}/agent/SMSCDRReports`, "X-Requested-With": "XMLHttpRequest" });
